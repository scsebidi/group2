...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { created_at: @manufacturer.created_at, name: @manufacturer.name, product_type: @manufacturer.product_type }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { created_at: @manufacturer.created_at, name: @manufacturer.name, product_type: @manufacturer.product_type }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
