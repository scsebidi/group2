...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { created_at: @product_image.created_at, desc: @product_image.desc, product_id: @product_image.product_id }
    end
  ...
  test "should update product_image" do
    patch :update, id: @product_image, product_image: { created_at: @product_image.created_at, desc: @product_image.desc, product_id: @product_image.product_id }
    assert_redirected_to product_image_path(assigns(:product_image))
  end
